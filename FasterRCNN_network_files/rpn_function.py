...
class AnchorsGenerator(nn.Module):
    ...
    Return:
        anchors (List[Tensor]): a tensor of shape (N, 4), where N is the number of one feature map anchors,
        List is the number of feature map.
    """
    ...
    def forward(self, image_list, feature_maps):
        ...
        """
            与普通创建变量的方法相比，torch.jit.annotate 提供了额外的类型信息，这对于优化和部署模型是非常有用的。
            在 TorchScript 中，具有明确类型信息的对象通常可以更有效地进行优化，从而提高模型的性能和效率。
        """
